        ...
        $accounts = [
            [
                'user' => [
                    ...
                    'avatar' => 'files/_test/'.random_int(1, 10).'.jpg',
        ...
        $permissions = [
            ...
            [
                ...
                'detail' => [
                    [
                        'name' => 'create-link',
                        'display_name' => 'ایجاد لینک',
                        'description' => 'توانایی ایجاد لینک',
                    ],
                    [
                        'name' => 'read-link',
                        'display_name' => 'مشاهده لینک',
                        'description' => 'توانایی مشاهده لینک',
                    ],
                    [
                        'name' => 'edit-link',
                        'display_name' => 'ویرایش لینک',
                        'description' => 'توانایی ویرایش لینک',
                    ],
                    [
                        'name' => 'delete-link',
                        'display_name' => 'حذف لینک',
                        'description' => 'توانایی حذف لینک',
                    ],
                ],
            ],
            // Menu
