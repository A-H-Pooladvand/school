...
# Service
Breadcrumbs::register('service', function (Breadcrumb $breadcrumbs) {
    $breadcrumbs->push('لیست خدمت ها', route('admin.service.index'));
});

# Service > Create
Breadcrumbs::register('service-create', function (Breadcrumb $breadcrumbs) {
    $breadcrumbs->parent('service');
    $breadcrumbs->push('افزودن خدمت', route('admin.service.create'));
});

# Service > Show
Breadcrumbs::register('service-show', function (Breadcrumb $breadcrumbs, $service) {
    $breadcrumbs->parent('service');
    $breadcrumbs->push('مشاهده خدمت', route('admin.service.show', $service->id));
});

# Service > Show > Edit
Breadcrumbs::register('service-edit', function (Breadcrumb $breadcrumbs, $service) {
...
# Categories
Breadcrumbs::register('service-categories', function (Breadcrumb $breadcrumbs) {
    $breadcrumbs->push('لیست دسته بندی خدمت ها', route('admin.service.category.index'));
});

# Category > Create
Breadcrumbs::register('service-category-create', function (Breadcrumb $breadcrumbs) {
    $breadcrumbs->parent('service-categories');
    $breadcrumbs->push('افزودن دسته بندی خدمت', route('admin.service.category.create'));
});

# Category > Show
Breadcrumbs::register('service-category-show', function (Breadcrumb $breadcrumbs, $category) {
    $breadcrumbs->parent('service-categories');
    $breadcrumbs->push('مشاهده دسته بندی خدمت', route('admin.service.category.show', $category->id));
});

# Categories > Show > Edit
Breadcrumbs::register('service-category-edit', function (Breadcrumb $breadcrumbs, $category) {
...
# Notifications
Breadcrumbs::register('notification', function (Breadcrumb $breadcrumbs) {
    $breadcrumbs->push('لیست اطلاعیه ها', route('admin.notification.index'));
});

# Notifications > Create
Breadcrumbs::register('notification-create', function (Breadcrumb $breadcrumbs) {
    $breadcrumbs->parent('notification');
    $breadcrumbs->push('افزودن اطلاعیه', route('admin.notification.create'));
});

# Notifications > Show
Breadcrumbs::register('notification-show', function (Breadcrumb $breadcrumbs, $notification) {
    $breadcrumbs->parent('notification');
    $breadcrumbs->push('مشاهده اطلاعیه', route('admin.notification.show', $notification->id));
});

# Notifications > Show > Edit
Breadcrumbs::register('notification-edit', function (Breadcrumb $breadcrumbs, $notification) {
...
# Categories
Breadcrumbs::register('notification-categories', function (Breadcrumb $breadcrumbs) {
    $breadcrumbs->push('لیست دسته بندی اطلاعیه ها', route('admin.notification.category.index'));
});

# Category > Create
Breadcrumbs::register('notification-category-create', function (Breadcrumb $breadcrumbs) {
...
# Category > Show
Breadcrumbs::register('notification-category-show', function (Breadcrumb $breadcrumbs, $category) {
    $breadcrumbs->parent('notification-categories');
    $breadcrumbs->push('مشاهده دسته بندی اطلاعیه', route('admin.notification.category.show', $category->id));
});

# Categories > Show > Edit
Breadcrumbs::register('notification-category-edit', function (Breadcrumb $breadcrumbs, $category) {
