...
@section('content')
    ...
    @push('scripts')
        <script>
            ...
            $('#tt').iTreeGrid({
                    title: 'لیست دسته بندی های اطلاعیه ها',
                    url: '{{ route('admin.notification.category.items') }}',
                    idField: 'id',
                    treeField: 'title',
                    columns: [[
                    ...
                    toolbar: [
                        {
                            name: 'show',
                            link: '{{ route('admin.notification.category.index') }}' + '/' + '{id}',
                        },
                        {
                            name: 'edit',
                            link: '{{ route('admin.notification.category.index') }}' + '/' + 'edit' + '/' + '{id}',
                        },
                        {
                            name: 'delete',
                            link: '{{ route('admin.notification.category.index') }}' + '/' + '{id}',
