...
{{--    <meta name="msapplication-TileImage" content={{ asset('"assets_front/images/favicons/ms-icon-144x144.png"') }}>--}}
    ...
    <link href="{{ asset('assets_front/lib/owl.carousel/dist/assets_front/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets_front/lib/owl.carousel/dist/assets_front/owl.theme.default.min.css') }}" rel="stylesheet">
...
<main>
    ...
    <section class="home-section home-parallax home-fade home-full-height bg-dark bg-dark-30" id="home" data-background={{ asset('"assets_front/images/section-4.jpg"') }}>
        <div class="titan-caption">
            <div class="caption-content">
                ...
                <div class="font-alt mt-30"><a class="btn btn-border-w btn-round" href="{{ route('home') }}">Back to home page</a></div>
            </div>
        </div>
    </section>
</main>
