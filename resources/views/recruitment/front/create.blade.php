                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="input_full_name" class="control-label">نام کامل</label>
                            <input id="input_full_name" name="full_name" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="input_phone" class="control-label">شماره تماس</label>
                            <input id="input_phone" name="phone" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="input_education" class="control-label">تحصیلات</label>
                            <input id="input_education" name="education" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="input_job_position" class="control-label">شغل مورد درخواست</label>
                            <input id="input_job_position" name="job_position" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="input_address" class="control-label">آدرس محل سکونت</label>
                        ...
                        <div class="form-group">
                            <label for="input_collaboration_type" class="control-label">نوع همکاری</label>
                        ...
                        <div class="form-group">
                            <label for="input_file" class="control-label">ارسال فایل رزومه</label>
