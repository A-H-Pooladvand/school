...
<link rel="stylesheet" type="text/css" href="{{ asset('_site/css/owl.carousel.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('_site/css/owl.transitions.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('_site/css/cubeportfolio.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('_site/css/settings.css') }}">
