    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-4 footer_panel bottom25">
                ...
                <a href="index.html" class="footer_logo bottom25"><img src="{{ asset('_site/images/logo-white.png') }}" alt="Edua"></a>
            ...
            <div class="col-md-4 col-sm-4 footer_panel bottom25">
                ...
                <img src="{{ asset('_site/images/footer-map.png') }}" alt="we are here" class="img-responsive">
            </div>
        </div>
    </div>
</footer>
