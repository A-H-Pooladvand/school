...
jQuery(document).ready(function(){
    ...
    homeSlider.on("changed.owl.carousel", function (e) {
        var itemsToAnimate = $("#home-slider .owl-item").eq(e.item.index).find("[data-animation]");
        itemsToAnimate.each(function () {
            var elem = $(this);
            var animation = "animated " + elem.data("animation");
            elem.addClass(animation).one("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd", function () {
